...
class CanvasMarkerLayer extends StatelessWidget {
  ...
  const CanvasMarkerLayer({super.key, required this.markers, this.showDebugRect = false, this.showDebugHitArea = false, this.drawHitMarkerLast = false, this.cullMarkers = true});
